 ...
 * 
 * Modernized in 2024 by Jim Bridger
 */
...
/** @type {number} Time between updates in milliseconds */
let simulationTimestep = 1000 / 60

// The cumulative amount of in-app time that hasn't been simulated yet.
// See the comments inside animate() for details.

/** @type {number} Cumulative amount of time that hasn't been simulated */
let frameDelta = 0

// The timestamp in milliseconds of the last time the main loop was run.
// Used to compute the time elapsed between frames.

/** @type {number} Last time the main loop was run */
let lastFrameTimeMs = 0

// An exponential moving average of the frames per second.

/** @type {number} Exponential moving average of frames per second */
let fps = 60
...
/** @type {number} Weight given to more recent seconds in FPS calculation */
let fpsAlpha = 0.9
...
/** @type {number} Number of update steps in current frame */
...
/** @type {number} Minimum time between frames in milliseconds */
let minFrameDelay = 0

// Whether the main loop is running.

/** @type {boolean} Whether the main loop is running */
let running = false
...
/** @type {boolean} Whether MainLoop.start() has been called */
let started = false
...
/** @type {boolean} Whether too many updates have been attempted */
let panic = false
 ...
 * Request animation frame function with fallback
 */
...
// NOTE: This may not be true anymore in 2024.
// A cursory search found 3 benchmarks; for, against, and tied.
// Also, given svelte-mainloop is providing a function anyway, it's irrelevant.
// Still, for now I'm leaving this as close to the original as possible,
// in case other devs want to use the modernized version.
// I may update it further in a future release. - Jim

// Stage functions with their proper parameter signatures

// A function that runs at the beginning of the main loop.
// See `MainLoop.setBegin()` for details.
/** @type {(timestamp: number, delta: number) => void} */
let begin = function (_, __) { }
...
/** @type {Object} The main loop controller */
export default {
   /**
   ...
   /** @returns {number} The simulation timestep */
   ...
   /** 
    * @param {number} timestep The timestep in milliseconds
    * @returns {Object} The MainLoop object for method chaining
    */
   ...
   /** @returns {number} Exponential moving average of FPS */
   getFPS: function () {
      return fps
   },
   ...
   /** @returns {number} The maximum allowed FPS */
   ...
   /** 
    * @param {number} [fps=Infinity] The maximum allowed FPS
    * @returns {Object} The MainLoop object for method chaining
    */
   ...
   /** @returns {number} The old frame delta */
   ...
   /** 
    * @param {(timestamp: number, delta: number) => void} [fun] The begin function
    * @returns {Object} The MainLoop object for method chaining
    */
   ...
   /** 
    * @param {(delta: number) => void} [fun] The update function
    * @returns {Object} The MainLoop object for method chaining
    */
   ...
   /** 
    * @param {(interpolationPercentage: number) => void} [fun] The draw function
    * @returns {Object} The MainLoop object for method chaining
    */
   ...
   /** 
    * @param {(fps: number, panic: boolean) => void} [fun] The end function
    * @returns {Object} The MainLoop object for method chaining
    */
   setEnd: function (fun) {
      end = fun || end
   ...
   /** @returns {boolean} Whether the main loop is running */
   isRunning: function () {
      return running
   },
}